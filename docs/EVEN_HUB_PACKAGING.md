...
0.2.10 候选：配合附近商家营业状态核验后端发布，提升包版本便于 Portal 上传。
客户端代码与 0.2.9 相同，首次自动开麦、后续按住说话与手动翻页均不变。
包名 `glass-assistant-0.2.10.ehpk`；商家核验逻辑只在后端，旧 0.2.9 同样受益。
本轮重点真机验证 Target 不误选停车场、推荐追问与营业状态说明。
