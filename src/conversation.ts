...
export type ReplyUpdate = { type: 'search.status'; status: string } | { type: 'answer.citations'; text: string; citations: Citation[] };
...
export type TurnPlan = { decision: Decision; reasoningEffort?: ReasoningEffort };
