...
Natural spoken approvals such as 可以，发给我吧 / 好，就把这份发到我的邮箱 / 行，麻烦发一下 / yes please send that to me also count as confirm when bound to that immediately preceding preview. Do not require a magic phrase. Generic 好的 without a sending instruction remains unclear assent.
